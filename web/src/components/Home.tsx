  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-6xl space-y-16 px-5 pb-20">
        <Showcase src={printerDetail} alt="Monitor detail with live risk score and printer controls" w={1360} h={860} kicker="EVERY MONITOR, IN DEPTH" title="Open any monitor" body="Live risk score, score history and one-tap pause, resume or cancel, bound to the printer through your print server." />
