...
- **WebRTC video via MediaMTX** — pull any RTSP/RTMP/HTTP source, publish a browser
  camera over WHIP, auto-discover streams already pushed to the server; live playback
  over WHEP.
